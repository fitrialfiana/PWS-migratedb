 ...
 */
package com.ti.migrateedb;

import com.ti.migrateedb.exceptions.IllegalOrphanException;
import com.ti.migrateedb.exceptions.NonexistentEntityException;
import com.ti.migrateedb.exceptions.PreexistingEntityException;
...
public class Member1JpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.ti_migrateedb_jar_0.0.1-SNAPSHOTPU");
